...
class MainView(WizardPage):
    def __init__(self, main):
        ...
        self.main.add_wizard_page(self, "OBJECT MIGRATION", "Manual Editing")
        self._object_dict = {}
    ...
    def create_ui(self):
        ...
        hbox.add(mforms.newLabel("Migrated Objects"), False, False)
        ...
        self._no_errors = mforms.newLabel("No mapping problems found.\nUse the View pulldown menu to review all objects.")
        ...
        if sys.platform == "win32":
            l = mforms.newLabel("You can rename target schemas and tables and change column definitions by selecting the item and pressing F2.")
        else:
            l = mforms.newLabel("You can rename target schemas and tables and change column definitions by clicking them once selected.")
    ...
    def _filter_changed(self):
        ...
        if i == 0: # errors only
            ...
            if self._tree.root_node().count() == 0:
    ...
    def scan_objects_with_errors(self, source_catalog, target_catalog):
        def check_object(obj, list):
            tobj = find_object_with_old_name(list, obj.name)
    ...
    def refresh_columns_tree(self):
        ...
        prepend_schema = len(source_catalog.schemata) > 1
    ...
    def refresh_full_tree(self):
        ...
        if not self._filter_errors:
            ...
            if obj:
                node = self._add_node(None, None, obj, "GrtObject.16x16.png")
